  ...
  async send(e2, t2) {
    ...
    return (t2.fetch || fetch)(s2, t2).then(async (e3) => {
      ...
      try {
        ...
        if (((_a = t2.signal) == null ? void 0 : _a.aborted) || "undefined" != typeof DOMException && e4 instanceof DOMException && ("AbortError" == e4.name || 20 == e4.code)) throw e4;
      }
